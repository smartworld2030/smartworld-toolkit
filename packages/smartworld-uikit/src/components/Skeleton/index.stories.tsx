...
export const ShapeCricle: React.FC = (args) => {
  return <Skeleton animation="waves" variant="circle" size="large" />
}
...
export const Cirlce: React.FC = (args) => {
  const [loading, setLoading] = useState(true)
  ...
  return <Button shape="circle">{loading ? <Skeleton animation="waves" variant="circle" {...args} /> : 'H1'}</Button>
}
