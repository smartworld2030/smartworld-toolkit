...
export const TokenImages: React.FC = () => {
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        const src = `https://new.smartworld.app/assets/images/tokens/${token.address[56]}.svg`
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        ...
        const primarySrc = `https://new.smartworld.app/assets/images/tokens/${token.address[56]}.svg`
        const secondarySrc = `https://new.smartworld.app/assets/images/tokens/${tokens[randomTokenIndex].address[56]}.svg`
