...
export const TokenImages: React.FC = () => {
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        const src = `https://new.smartworld.app/images/tokens/${token.address[56]}.svg`
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        ...
        const primarySrc = `https://smartworld.app/images/tokens/${token.address[56]}.svg`
        const secondarySrc = `https://smartworld.app/images/tokens/${tokens[randomTokenIndex].address[56]}.svg`
